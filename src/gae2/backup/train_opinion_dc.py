...
from gae.input_data import load_data_dc
...
for k in range(180):
    ...
    y_train_belief, y_test_belief, y_train_un, y_test_un, train_mask, test_mask, omega_test, alpha_0, beta_0 = mask_test_edge_opinion(
        FLAGS.test_rat, index=k)
    bf_mse_one = []
    b_mse_one = []
    u_mse_one = []
    t1 = time.time()
