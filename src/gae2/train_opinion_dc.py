...
from input_data import load_data_dc
...
flags.DEFINE_float('test_rat', 0.8, 'test number of dataset.')
...
# adj, features = load_data_dc()
root="/network/rit/lab/ceashpc/adil/data/csl-data/Dec10/dc/" #Sep18
for hour in range(8,22):
    fileName=root+"network_dc_weekday_0_hour_{}_refspeed_0.6-testratio-0.2-confictratio-0.3-realization-0.pkl".format(hour)
    print(fileName)
