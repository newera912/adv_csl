...
class Task_inference(object):
    ...
    def __call__(self):
        ...
        p_t, b_t,sign_grad_py_t  = admm(self.omega, self.b, self.y_t, self.Y, self.X, self.node_nns,
...
def inference_apdm_format(V, E, Obs, Omega, b, X, logging, psl=False, approx=True, init_alpha_beta=(1, 1),
    ...
    _, _, sign_grad_py_ids= inference(omega_y, omega_0, y, X, Y, T, node_nns, R, logging, psl,
