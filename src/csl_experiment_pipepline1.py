...
def experiment_proc_server():
    logging = Log()
    data_root = "/network/rit/lab/ceashpc/adil/data/csl-data/May23-3/"  #May23 May23-3
    methods = ["csl", "csl-3-rules", "csl-3-rules-conflict-evidence", "sl"][2:3]
    ...
    for graph_size in graph_sizes[1:2]:
        for T in [2,4,6,8, 9, 10, 11,21][5:6]:    #5,6,10,20,11,21,15
