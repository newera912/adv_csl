...
from gae.preprocessing import preprocess_graph, construct_feed_dict, sparse_to_tuple, mask_test_edge_opinion_f
...
flags.DEFINE_integer('test_num', 200, 'test number of dataset.')
...
# adj = adj_train
adj_train = adj
y_train_belief, y_test_belief, y_train_un, y_test_un, train_mask, test_mask, omega_test, f = mask_test_edge_opinion_f(FLAGS.test_num, FLAGS.noise)
features = f
if FLAGS.features == 0:
