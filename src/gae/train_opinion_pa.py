...
root="/network/rit/lab/ceashpc/adil/data/csl-data/Dec10/philly/"  #Sep18
for hour in range(8,22):
    fileName=root+"network_philly_weekday_0_hour_{}_refspeed_0.6-testratio-0.2-confictratio-0.3-realization-0.pkl".format(hour)
    print(fileName)
