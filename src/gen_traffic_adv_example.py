...
class Task_inference(object):
    ...
    def __call__(self):
        ...
        #                omega, b, y_t, Y, X, edge_up_nns,edge_down_nns, omega_0, R, psl, approx, report_stat
        p_t, b_t,sign_grad_py_t = admm(self.omega, self.b, self.y_t, self.Y, self.X, self.edge_up_nns, self.edge_down_nns,
...
def inference_apdm_format(V, E, Obs, Omega, b, X, logging, psl=False, approx=True, init_alpha_beta=(1, 1),
    ...
    _, _, sign_grad_py_ids = inference(omega_y, omega_0, y, X, Y, T, edge_up_nns, edge_down_nns, R, logging, psl,
